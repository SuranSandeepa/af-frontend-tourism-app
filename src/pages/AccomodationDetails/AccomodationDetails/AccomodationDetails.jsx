    ...
    <div>
      <div className="m-5">
        ...
        <div className="grid grid-cols-2 justify-center items-center">
          ...
          <div>
            <div className="rounded-full w-14 h-14 border border-1 border-black flex justify-center items-center">
              <svg width="30" height="32" className="object-cover">
                <path
        ...
        <div className="flex justify-between">
          <div className="flex-[0.8]">
            ...
            <div>
              ...
              luctus dignissim condimentum. Integer ullamcorper nulla eleifend
              blandit bibendum. Phasellus consequat mi vitae dui mollis cursus.
              Duis convallis augue eget turpis ullamcorper, in pulvinar erat
              imperdiet. Vivamus dapibus eros purus, sed aliquet elit placerat
              sit amet. Quisque elementum lectus in lectus scelerisque, a
              accumsan mi bibendum. Fusce mattis dui sed egestas tempus. Etiam
              pharetra molestie velit bibendum ullamcorper. Nullam feugiat ipsum
              eu enim finibus consequat. Aliquam vulputate enim et turpis
              tincidunt finibus. Nulla laoreet tempus purus non ultrices.
              Phasellus ac ornare mi, a tincidunt odio. Aliquam aliquet orci a
              mauris tincidunt, ac volutpat lectus faucibus. Maecenas in mattis
              elit. Duis non mauris non augue imperdiet rutrum. Aliquam turpis
              mi, vestibulum ac semper ac, congue id sapien.
            </div>
          </div>
          <div className="pt-4 pr-4">
            <div className="p-4 border-[2px] border-black rounded-xl w-72">
              ...
              <div className="grid grid-cols-2 border-[1px] rounded-md border-black text-sm">
                ...
                <div className="p-2 col-span-2 border-t-[1px] border-black">
                  <span className="font-semibold text-gray-600 text-xs">
                    Guests
                  </span>
                  <br />
